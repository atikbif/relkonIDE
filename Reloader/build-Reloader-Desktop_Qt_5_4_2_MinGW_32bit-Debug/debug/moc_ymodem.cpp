...
#include "../../Reloader/Loader/ymodem.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Ymodem_t, stringdata) + ofs \
...
void Ymodem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Ymodem::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ymodem::finished)) {
                *result = 0;
            }
        }
        {
            typedef void (Ymodem::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ymodem::percentUpdate)) {
                *result = 1;
            }
        }
        {
            typedef void (Ymodem::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ymodem::bootError)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject Ymodem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Ymodem.data,
      qt_meta_data_Ymodem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Ymodem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Ymodem.stringdata))
        return static_cast<void*>(const_cast< Ymodem*>(this));
