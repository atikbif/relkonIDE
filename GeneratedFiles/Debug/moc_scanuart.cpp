...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ScanUART_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(7, 73, 16), // "SearchController"
QT_MOC_LITERAL(8, 90, 3), // "plc"
QT_MOC_LITERAL(9, 94, 10), // "portIsBusy"
QT_MOC_LITERAL(10, 105, 9), // "startScan"
QT_MOC_LITERAL(11, 115, 5), // "pName"
QT_MOC_LITERAL(12, 121, 8) // "stopScan"

    },
    "ScanUART\0percentUpdate\0\0percValue\0"
    "scanIsFinished\0message\0plcHasBeenFound\0"
    "SearchController\0plc\0portIsBusy\0"
    "startScan\0pName\0stopScan"
};
...
void ScanUART::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->plcHasBeenFound((*reinterpret_cast< SearchController(*)>(_a[1]))); break;
        case 3: _t->portIsBusy(); break;
        case 4: _t->startScan((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ScanUART::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScanUART::percentUpdate)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ScanUART::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScanUART::scanIsFinished)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ScanUART::*)(SearchController );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScanUART::plcHasBeenFound)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (ScanUART::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScanUART::portIsBusy)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ScanUART::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ScanUART.data,
      qt_meta_data_ScanUART,  qt_static_metacall, nullptr, nullptr}
};
...
void *ScanUART::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScanUART.stringdata0))
...
// SIGNAL 2
void ScanUART::plcHasBeenFound(SearchController _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
