...
void YmodemThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (YmodemThread::*)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&YmodemThread::startProcess)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject YmodemThread::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_YmodemThread.data,
      qt_meta_data_YmodemThread,  qt_static_metacall, nullptr, nullptr}
};
