...
void SysFramReadWrite::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SysFramReadWrite::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SysFramReadWrite::startWrite)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SysFramReadWrite::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SysFramReadWrite::startRead)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SysFramReadWrite::*)(const QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SysFramReadWrite::readOK)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SysFramReadWrite::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SysFramReadWrite.data,
      qt_meta_data_SysFramReadWrite,  qt_static_metacall, nullptr, nullptr}
};
