...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sFram_t, stringdata0) + ofs \
...
void sFram::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (sFram::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&sFram::writeFinished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (sFram::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&sFram::readFinished)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (sFram::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&sFram::error)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (sFram::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&sFram::percentUpdate)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject sFram::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_sFram.data,
      qt_meta_data_sFram,  qt_static_metacall, nullptr, nullptr}
};
...
void *sFram::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sFram.stringdata0))
