...
QString MatchboxExistance::getMatchboxFile()
{
    ...
    if(!PLCUtils::hasNoIO(plc)) {
        if(plc=="PC470") {
            ...
            res += QString(" IN0 IN1 IN2 IN3 OUT0 OUT1 OUT2 OUT3 ADC1 ADC2 ADC3 ADC4 ADC5 ADC6 ADC7 ADC8ADC201 ADC202 ADC203 ADC204 ADC205 ADC206 ADC207 ADC208 DAC1 DAC2 ");
