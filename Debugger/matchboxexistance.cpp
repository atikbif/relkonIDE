...
QString MatchboxExistance::getMatchboxFile()
{
    ...
    if(!PLCUtils::hasNoIO(plc)) {
        if(plc=="PC470") {
            res += QString(" IN0 IN1 IN2 IN3 OUT0 OUT1 OUT2 OUT3 ADC1 ADC2 ADC201 ADC202 ADC203 ADC204 ADC205 ADC206 ADC207 ADC208 DAC1 DAC2 ");
        }else if(plc=="PC471") {
            res += QString(" IN0 IN1 IN2 IN3 OUT0 OUT1 OUT2 OUT3 ADC1 ADC2 ADC201 ADC202 ADC203 ADC204 ADC205 ADC206 DAC1 DAC2 ");
        }else if(plc=="PC472") {
            res += QString(" IN0 IN1 IN2 IN3 OUT0 OUT1 OUT2 OUT3 ADC1 ADC2 ADC201 ADC202 ADC203 ADC204 ADC205 ADC206 ADC207 ADC208 DAC1 DAC2 ");
        }else if(plc=="X6X B") {
            ...
            res += QString(" IN0 IN1 IN2 IN3 OUT0 OUT1 OUT2 OUT3 ADC201 ADC202 ADC203 ADC204 ADC205 ADC206 ADC207 ADC208 DAC1 DAC2 ");
