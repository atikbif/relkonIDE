...
static const uint qt_meta_data_Display[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Int, QMetaType::Int, QMetaType::Int,    6,    8,
    QMetaType::Int, QMetaType::Int, QMetaType::Int,   10,    8,
...
void Display::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { int _r = _t->cursorPosChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: { int _r = _t->strListChanged((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 2: { int _r = _t->curStrNumChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 3: { int _r = _t->strChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        default: ;
        }
        ...
        {
            typedef int (Display::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Display::cursorPosChanged)) {
                *result = 0;
            }
        }
        {
            typedef int (Display::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Display::strListChanged)) {
                *result = 1;
            }
        }
        {
            typedef int (Display::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Display::curStrNumChanged)) {
                *result = 2;
            }
        }
        {
            typedef int (Display::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Display::strChanged)) {
                *result = 3;
            }
        }
    }
...
// SIGNAL 0
int Display::cursorPosChanged(int _t1, int _t2)
{
    int _t0 = int();
...
// SIGNAL 1
int Display::strListChanged(int _t1)
{
    int _t0 = int();
...
// SIGNAL 2
int Display::curStrNumChanged(int _t1, int _t2)
{
    int _t0 = int();
    void *_a[] = { const_cast<void*>(reinterpret_cast<const void*>(&_t0)), const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 3
int Display::strChanged(int _t1, int _t2)
{
    int _t0 = int();
    void *_a[] = { const_cast<void*>(reinterpret_cast<const void*>(&_t0)), const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
